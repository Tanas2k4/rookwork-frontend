      ...
      <div className="flex items-center gap-3 mb-2 ">
        <div className="relative w-80">
          ...
          <input
            ...
            className="w-full bg-white border border-gray-200 rounded-lg pl-9 pr-3 py-1.5 text-xs
        ...
        <div className="relative shrink-0 select-none">
          <button
            ...
            className="flex items-center justify-between bg-white border border-gray-200 text-gray-700 text-xs rounded-lg pl-3 pr-2.5 py-1.5 font-semibold focus:outline-none hover:border-purple-800 focus:border-purple-800 transition cursor-pointer gap-2 w-36"
          >
            <span>
